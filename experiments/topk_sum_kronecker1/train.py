...
rss = [
    [32, 64, 128, 256, 512, 1024, 2048],    # 1755.
    [16, 32, 64, 128, 256, 512, 1024],    # 733.
    [16, 32, 64, 128, 256, 512, 1024],    # 945.
    [4, 8, 16, 32, 64, 128, 256],    # 191.
    [4, 8, 16, 32, 64, 128, 256],    # 254.
    [16, 32, 64, 128, 256, 512, 1024],    # 733.
    [16, 32, 64, 128, 256, 512, 1024],   # 733.
    [4, 8, 16, 32, 64, 128, 512],    # 191.
    [4, 8, 16, 32, 64, 128, 512]   # 191.
]
...
if __name__ == '__main__':
    ...
    use_wandb = False
    log_steps = 5
    save_dir = f"/om2/user/ericjm/structured-sae/experiments/topk_sum_kronecker1/{d1}x{d2}-{d3}x{d4}/"
