...
def main(idx):
    ...
    for r in tqdm(rs):
        ...
        sum_kronecker_encoder_parameters[r] = W1.numel() + W2.numel() + U.numel()
    ...
    with open(os.path.join(base_dir, f"saved_data/layer{layer_index}_{location}_v5_32k_encoder_sum_kronecker_{d1}x{d2}_{d3}x{d4}_rightmult_results.pkl"), "wb") as f:
